...
export function SandboxCard({ 
  ...
  return (
    <div className={cn(
      ...
      isRunning ? "border-[var(--md3-primary)]/30 glow-primary" : "border-white/5",
      className
    )}>
      ...
      <div className="relative z-10 flex items-start justify-between">
        <div>
          <h3 className="flex items-center gap-2 font-headline text-xl font-bold tracking-tight text-white">
            {sandbox.name}
            {isRunning && (
        ...
        <div className="flex items-center gap-1 z-50">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                type="button"
                className="rounded-full flex items-center justify-center p-2 text-[var(--md3-on-surface-variant)] transition-colors hover:bg-white/10 hover:text-white shrink-0 outline-none"
      ...
      <div className="relative z-10 my-8">
        <div className="flex items-center gap-3 bg-black/40 border border-white/5 rounded-2xl p-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-sm font-medium text-white font-mono mt-0.5">{sandbox.image || "Universal"}</span>
          </div>
        </div>
        ...
        {isRunning ? (
          ...
          <button
            ...
            className={cn(
              ...
              isTransitioning 
                ? "bg-black/20 text-[var(--md3-on-surface-variant)] cursor-not-allowed border-white/5" 
                : "bg-[var(--md3-primary)]/10 text-[var(--md3-primary)] hover:bg-[var(--md3-primary)] hover:text-white shadow-[0_0_15px_rgba(173,163,255,0.1)] hover:shadow-[0_0_20px_rgba(173,163,255,0.4)] active:scale-95 border-[var(--md3-primary)]/30"
            )}
          >
...
export function NewSandboxCard({ onClick, className }: NewSandboxCardProps) {
  return (
    ...
    >
      ...
      <span className="mt-6 font-headline text-xl font-bold text-white tracking-tight">
        New Sandbox
      </span>
