...
export const InNavbar: Story = {
  name: 'In Navbar',
  render: () => (
    <div className="flex w-full max-w-[min(640px,calc(100vw-2rem))] flex-wrap items-center justify-between gap-y-3 rounded-xl border border-border bg-card px-4 py-3">
      <Logo size="md" variant="sandbox" />
