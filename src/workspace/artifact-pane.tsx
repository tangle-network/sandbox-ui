...
export function ArtifactPane({
  ...
  return (
    <section
      className={cn(
        "flex h-full min-h-0 flex-col overflow-hidden rounded-[var(--radius-xl)] bg-[linear-gradient(180deg,rgba(255,255,255,0.02),transparent_18%),hsl(var(--background))] text-foreground",
        className,
      )}
    >
      <header className="border-b border-border bg-[radial-gradient(circle_at_top_left,rgba(98,114,243,0.12),transparent_34%),linear-gradient(180deg,rgba(255,255,255,0.04),transparent)]">
        <div className="flex items-start justify-between gap-3 px-4 py-3">
          <div className="min-w-0 flex-1">
            {eyebrow && (
              <div className="mb-1 inline-flex max-w-full items-center rounded-full border border-border bg-primary/10 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-primary">
                {eyebrow}
              </div>
            )}
