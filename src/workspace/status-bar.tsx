...
export function StatusBar({
  ...
  return (
    <div
      className={cn(
        "flex items-center gap-3 px-3 py-1 border-t border-[var(--md3-outline-variant)] bg-surface-container-high text-[12px]",
        className,
      )}
    >
      {/* Model selector */}
      {modelLabel && (
        <button
          ...
          className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-[2px] border border-[var(--md3-outline-variant)] text-muted-foreground hover:border-primary/20 hover:text-foreground transition-colors"
        >
